...
class CaptchaError(DataFetchError):
    """Xiaohongshu requires manual CAPTCHA verification"""
...
class SessionExpiredError(RequestError):
    """Xiaohongshu browser session needs to be refreshed"""
