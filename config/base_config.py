...
KEYWORDS = ""  # Search keywords must be supplied explicitly.
...
# Optional normalized lead output (configured by the API process manager).
LEAD_MODE = os.getenv("MEDIACRAWLER_LEAD_MODE", "0") == "1"
LEAD_MAX_ACCOUNTS = int(os.getenv("MEDIACRAWLER_LEAD_MAX_ACCOUNTS", "0"))
LEAD_DEEP_PROFILE_LIMIT = int(os.getenv("MEDIACRAWLER_LEAD_DEEP_PROFILE_LIMIT", "30"))
LEAD_MAX_COMMENTS = int(os.getenv("MEDIACRAWLER_LEAD_MAX_COMMENTS", "300"))
