  ...
  return (
    <>
      <Card className={`relative overflow-hidden card-scan group transition-all ${styles.border} hover:shadow-[0_0_15px_rgb(var(--cyber-neon-cyan)/0.15)]`}>
        <label className="absolute right-3 top-3 z-10 flex items-center gap-1.5 text-xs text-cyber-text-secondary">
          <input
            type="checkbox"
            checked={selected}
        ...
        <CardContent className="p-4 relative">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="pr-14 font-mono font-medium text-sm text-cyber-text-primary truncate" title={file.name}>
                {file.name}
              </h3>
